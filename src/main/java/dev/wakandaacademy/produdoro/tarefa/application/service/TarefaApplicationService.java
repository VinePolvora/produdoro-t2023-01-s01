...
public class TarefaApplicationService implements TarefaService {
    ...
    private final UsuarioApplicationService usuarioApplicationSevice;
	...
	public void ativaTarefa(UUID idUsuario, UUID idTarefa) {
		 ...
		 usuarioApplicationSevice.buscaUsuarioPorId(idUsuario);
		 Tarefa tarefaId = tarefaRepository.buscaTarefaPorId(idTarefa).orElseThrow(() 
				 -> APIException.build(HttpStatus.NOT_FOUND, "Tarefa não encontrada!"));
		 tarefaRepository.desativaTarefas(idUsuario);
		 tarefaId.ativaTarefa();
		 tarefaRepository.salva(tarefaId);
